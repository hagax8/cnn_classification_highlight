...
def SimpleCNN():
    base_model = VGG16(include_top=False, weights=None, input_shape=(200,200,3))
    x = base_model.output
...
basemodel.save('first_cnn_test_vgg16.h5')
simpleCNN.save('first_cnn_test_vgg16.wholenet.h5')

plot_model(simpleCNN, to_file='first_cnn_test_vgg16.png')
