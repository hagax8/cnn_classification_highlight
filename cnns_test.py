...
#    pool4 = MaxPooling2D(2,2)(conv4)
    ...
    model = Model(inputs=main_input,outputs=main_output,name='SimpleCNN')
    return model
...
simpleCNN.save('first_cnn_test_ESR2_DUDE.h5')
train_generator.class_indices


plot_model(simpleCNN, to_file='first_cnn_test_ESR2_DUDE.png')
